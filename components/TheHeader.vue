        ...
        <div class="row">
          <div class="contacts">
            ...
            <div class="f-wrup">
              ...
              <a href="mailto:noanswer@nomail.com" class="contacts__mail">noanswer@nomail.com</a>
            </div>
          </div>
          <div class="user">
            <div v-if="isLogin" class="user__wrapper">
              <img class="user__avatar" :src="user.image" :alt="user.username + ' avatar'">
              <span class="user__name"> {{ user.username }} ({{ user.firstName }})</span>
            </div>
...
async function doLogin(e: MouseEvent) {
  ...
  const res = await logForm.value?.start(coordinates)
